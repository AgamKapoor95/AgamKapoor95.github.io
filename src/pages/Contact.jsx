    ...
    <Box p={{base:"5px 0px", md:"50px 0px"}} paddingBottom="20%" className="contact">
      <Heading m="auto"  pb={{base:"20px", md:"50px"}} >Get In Touch</Heading>
        <Flex textAlign="center" flexDirection={{base:"column",md:"row"}} justifyContent="space-around" w={{base:"90%", sm:"70%" }} m="auto" >
            <Button color="#c9fff3"  _hover={{  bg: 'teal.700'}} variant='outline' w="100%" borderColor="gray">Mobile No : 6284885626</Button>
            <Button color="#c9fff3"  _hover={{  bg: 'teal.700'}} variant='outline' w="100%" borderColor="gray">Email ID : agamkapoor191@gmail.com</Button>
        </Flex>
      <Text m="auto" w={{base:"90%", sm:"70%", md:"50%", lg:"40%" }} color="#64ffdb9a" > My inbox is always open. Whether you have a question or just want to say hi, I’ll try my best to get back to you!</Text>
      <Center p="30px" mt="50px">
        <Card align='center' border="1px solid #64FFDA" w={{base:"90%", sm:"70%", md:"50%", lg:"30%" }}>
          <form ref={form} onSubmit={sendEmail} style={{width:"100%", padding:"15px"}}>
            <input type="text" value="To : agamkapoor191@gmail.com" style={{backgroundColor:"#000F16", marginBottom:"10px", color:'#fff', borderBottom:"1px solid #64FFDA", width:"100%"}}/>
        ...
        <Flex textAlign="center" justifyContent="space-around" w={{base:"80%", sm:"50%", md:"30%" }} m="auto" templateColumns='repeat(auto-fill, minmax(30%, 1fr))'>
          <a href="https://github.com/AgamKapoor95" target="_blank" style={{width:"30%"}} >
            <IconButton variant='outline' w="100%" _hover={{ bg: 'teal.700', }} borderColor="" color='#64FFDA' aria-label='Send email' icon={ <SiGithub />  }/>          
          </a>
          <a href="https://www.linkedin.com/in/agam-3630a123a/" target="_blank" style={{width:"30%"}} >
            <IconButton variant='outline' w="100%" _hover={{ bg: 'teal.700', }} borderColor="" color='#64FFDA' aria-label='Send email' icon={<SiLinkedin />}/>
          </a>
          <Tippy theme='light' placement="bottom" content={<span style={{color:"#000F16"}} >agamkapoor191@gmail.com</span>} >
          <a href="mailto:agamkapoor191@gmail.com?body=Hello%2C%0D%0A%0D%0A" target="_blank" style={{width:"30%"}} >
